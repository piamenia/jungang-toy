package io.dktechin.eapproval.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	public Docket api() { // swagger 문서의 설정빈
		return new Docket(DocumentationType.SWAGGER_2)
			...
			.select()
			.apis(RequestHandlerSelectors.basePackage("io.dktechin.eapproval.controller"))  // 컨트롤러 패키지명으로 해당 패키지의 requsetmapping만 가져 올수 있다 TODO: 패키지 수정
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
			...
			"DKT 플랫폼개발팀 ",
			"v0.1",
			"https://dkt.agit.in/g/300039980/wall", // agit
			new Contact(
				"@@cpdev.mis",
				"",
				""),
