package io.dktechin.common.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	public Docket api() { // swagger 문서의 설정빈
		return new Docket(DocumentationType.SWAGGER_2)
			...
			.select()
			.apis(RequestHandlerSelectors.basePackage("io.dktechin.template.controller"))  // 컨트롤러 패키지명으로 해당 패키지의 requsetmapping만 가져 올수 있다 TODO: 패키지 수정
